/*Source from:Unity character standard asset/thirdpersonController
 some part of the code are being adapted due to the fact that different 
 character are using different inputs, changes can be found in the 
 fixedUptate() function.
*/
using System;
using UnityEngine;
